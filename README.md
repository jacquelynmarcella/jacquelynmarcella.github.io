...
## Tech stack + process
For my portfolio site, my goal was to keep things clear, readable, and performant. I didn't wan to over-engineer the site with complex frameworks given it's size and intended purpose (in my opinion, a React app for this type of site would not be the right tool for the job). I used the following basic stack:
- HTML5
- CSS3
...
- Checked color contrast ratios for all text and background colors
...
- Ensured that if a user had set `prefers-reduced-motion` to `true`, that animations were disabled
